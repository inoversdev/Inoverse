...
{
    id: 'taratext',
    image: '/projects/taratext.webp',
    name: 'TaraText',
    industry: 'Platform & SaaS',
    category: 'SMS Platform',
    description: 'SMS platform for Philippine businesses — campaigns, sender IDs, and delivery tracking in one dashboard.',
    url: 'https://taratext.com/',
    tags: ['Platform', 'SMS', 'Web'],
    featured: true,
    noInvert: true,
  },
{
...
export const CREW = [
  // Leadership
  {
    ...
    initials: 'JL',
    avatar: 'ember',
    bio: 'Sets the vision and leads engineering delivery.',
    photo: '/crew/lead-josua.webp',
    demo: false,
  },
  {
    id: 'lead-angelo',
    ...
    initials: 'AR',
    avatar: 'teal',
    bio: 'Drives growth, operations and the numbers behind every mission.',
    photo: '/crew/lead-angelo.webp',
    demo: false,
  },
  // Finance
  {
