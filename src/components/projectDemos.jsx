...
const STEPS = {
  ...
  silog: ['Order placed', 'Kitchen cooking', 'Rider en route', 'Delivered ✓'],
  tatay: ['Table picked', 'Grill fired', 'Order ready', 'Served ✓'],
  // Ride hailing
  byahego: ['Book ride', 'Driver assigned', 'Riding', 'Arrived ✓'],
  // Hotel / venue booking
  whatahotel: ['Pick dates', 'Choose room', 'Confirm', 'Booked ✓'],
  casa: ['Pick dates', 'Choose room', 'Confirm', 'Booked ✓'],
  // E-commerce
  ukay: ['Add to cart', 'Checkout', 'Paid', 'Shipped ✓'],
  palengke: ['Order produce', 'Vendor preps', 'Out for delivery', 'Delivered ✓'],
...
const KIND = {
  ...
  byahego: 'ride',
  // hotel / venue booking
  whatahotel: 'hotel', casa: 'hotel',
  // commerce
  ukay: 'commerce', palengke: 'commerce',
  // dashboard
  dmap: 'dashboard', agenxure: 'dashboard',
}
